...
func createEmbeds(games []data.PlaystationStoreGame) ([]*discordgo.MessageEmbed, error) {
...
func (w *DiscordXboxGameWriter) Write(ctx context.Context, games []data.PlaystationStoreGame) error {
	var result error
